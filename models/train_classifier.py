...
def load_data(database_filepath):
    """ Loading data from sqlite data file and split into features and targets
...
def tokenize(text):
    """Processing text, tokenize, remove stopwords 
...
def build_model():
    ...
    - Performa grid search based on paramters objects
...
def evaluate_model(model, X_test, Y_test, category_names):
    """Evaluating model against test data with classification report
    Input: trained model , test features (X_test), test targets (Y_test), categories names
...
def save_model(model, model_filepath):
    ...
    input: model, filepath to save pickle file 
    """
